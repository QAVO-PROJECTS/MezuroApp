...
namespace MezuroApp.Persistance.Concretes.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        private static Dictionary<string, object> CatSnap(Category c) => new()
        {
            ...
            ["nameRu"] = c.NameRu,
            ["nameTr"]= c.NameTr,
            ["descriptionAz"] = c.DescriptionAz,
            ["descriptionEn"] = c.DescriptionEn,
            ["descriptionRu"] = c.DescriptionRu,
            ["descriptionTr"] = c.DescriptionTr,
            ["metaTitleAz"] = c.MetaTitleAz,
            ["metaTitleEn"] = c.MetaTitleEn,
            ["metaTitleRu"] = c.MetaTitleRu,
            ["metaTitleTr"] = c.MetaTitleTr,
            ["metaDescriptionAz"] = c.MetaDescriptionAz,
            ["metaDescriptionEn"] = c.MetaDescriptionEn,
            ["metaDescriptionRu"] = c.MetaDescriptionRu,
            ["metaDescriptionTr"] = c.MetaDescriptionTr,
            ["slug"] = c.Slug,
            ["isActive"] = c.IsActive,
